...
# with command line options: step2Sonic -s PAT --era Run2_2018 -n 100 --process PAT --conditions auto:phase1_2018_realistic --mc --scenario pp --eventcontent MINIAODSIM --datatier MINIAODSIM --procModifiers run2_miniAOD_UL_preSummer20,allSonicTriton --no_exec --filein filelist:step1_dasquery.log --fileout file:step2Sonic.root
...
process = cms.Process('PAT',Run2_2018,run2_miniAOD_UL_preSummer20,allSonicTriton)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2Sonic nevts:100'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step2Sonic.root'),
