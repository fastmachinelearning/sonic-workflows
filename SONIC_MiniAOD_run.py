...
#parser.add_argument("--noSonic", default=True, action="store_true", help="disable SONIC in workflow")
...
parser.add_argument("--address", default="triton-2102.cms.geddes.rcac.purdue.edu", type=str, help="server address")
...
#parser.add_argument("--device", default="CPU", type=str, choices=allowed_devices, help="specify device for fallback server")
...
parser.add_argument("--tmi", default=True, action="store_true", help="include time/memory summary")
