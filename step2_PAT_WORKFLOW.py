...
# with command line options: step2 -s PAT,VALIDATION:@miniAODValidation,DQM:@miniAODDQM --era Run2_2017 -n 100 --process PAT --conditions auto:phase1_2017_realistic --mc --scenario pp --eventcontent MINIAODSIM,DQM --datatier MINIAODSIM,DQMIO --procModifiers run2_miniAOD_UL_preSummer20 --no_exec --filein filelist:step1_dasquery.log --fileout file:step2.root
...
process = cms.Process('PAT',Run2_2017,run2_miniAOD_UL_preSummer20,enableSonicTriton,photonDRN)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/mc/RunIISummer20UL17RECO/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/AODSIM/106X_mc2017_realistic_v6-v2/240010/1DEE74A6-11DD-3B49-BD8D-41CFD4F5932E.root',
        '/store/mc/RunIISummer20UL17RECO/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/AODSIM/106X_mc2017_realistic_v6-v2/240010/11523200-7605-1D47-BCFC-CFAAD3C53F1A.root',
        '/store/mc/RunIISummer20UL17RECO/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/AODSIM/106X_mc2017_realistic_v6-v2/240010/3F8DEBE8-90CE-8B4C-B979-CC77949C8C61.root'
    ),
